<?php
/**
 * Plugin Name: POI Model [Post Type]
...
/** MODEL CONFIGURATION **/
require_once plugin_dir_path(__FILE__) . '/POI.php';
function bs_poi_get_post_type()
{
...
function bs_poi_register_post_type()
{
	$model = bs_poi_get_post_type();
	$labels = array(
...
function bs_poi_create_custom_params()
{
	$model = bs_poi_get_post_type();
...
function bs_poi_register($customType)
{
	$model = bs_poi_get_post_type();
...
function bs_poi_callback($fieldType)
{
	$model = bs_poi_get_post_type();
	$customField = $model->customFields;
...
function bs_poi_on_save($post_id)
{
...
add_action('init', 'bs_poi_register_post_type');
add_action('save_post', 'bs_poi_on_save');
bs_poi_create_custom_params();

function bs_poi_cordX_register()
{
	bs_poi_register('cordX');
}

function bs_poi_cordX_callback()
{
	bs_poi_callback('cordX');
}

function bs_poi_cordY_register()
{
	bs_poi_register('cordY');
}

function bs_poi_cordY_callback()
{
	bs_poi_callback('cordY');
}

function bs_poi_affiliateLink_register()
{
	bs_poi_register('affiliateLink');
}

function bs_poi_affiliateLink_callback()
{
	bs_poi_callback('affiliateLink');
}

function bs_poi_affiliateCTA_register()
{
	bs_poi_register('affiliateCTA');
}

function bs_poi_affiliateCTA_callback()
{
	bs_poi_callback('affiliateCTA');
}
